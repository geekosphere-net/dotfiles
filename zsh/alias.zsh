...
alias mvnn="docker run -v ~/.m2:/var/maven/.m2 -v \$PWD:/usr/src/app -w /usr/src/app -ti --rm -u $(id -u ${whoami}):$(id -g ${whoami}) -e MAVEN_CONFIG=/var/maven/.m2 maven:3-jdk-8-slim mvn -Duser.home=/var/maven "
